  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <Text style={{color: Colors.WHITEDARK, textAlign: 'center'}}>
          Log out
        </Text>
      </TouchableOpacity>
      ...
      <View style={styles.BottomTabsContainer}>
        <TouchableOpacity
          ...
          <Ionicons
            ...
            size={24}
            color={CurrentScreen == 'Dashboard' ? Colors.BLUE : Colors.GRAY}
          />
          <Text
            style={[
              styles.TabText,
        ...
        <TouchableOpacity
          style={styles.TabBox}
          onPress={() => setCurrentScreen('RoomsScreen')}>
          <Ionicons
            name={CurrentScreen == 'RoomsScreen' ? 'bed' : 'bed-outline'}
            size={24}
            color={CurrentScreen == 'RoomsScreen' ? Colors.BLUE : Colors.GRAY}
          />
          <Text
            style={[
              styles.TabText,
              {
                color:
                  CurrentScreen == 'RoomsScreen' ? Colors.BLUE : Colors.GRAY,
              },
            ]}>
            Rooms
          </Text>
        ...
        <TouchableOpacity
          style={styles.TabBox}
          onPress={() => setCurrentScreen('NewTenants')}>
          <Ionicons
            name={CurrentScreen == 'NewTenants' ? 'people' : 'people-outline'}
            size={24}
            color={CurrentScreen == 'NewTenants' ? Colors.BLUE : Colors.GRAY}
          />
          <Text
            style={[
              styles.TabText,
              {
                color:
                  CurrentScreen == 'NewTenants' ? Colors.BLUE : Colors.GRAY,
              },
            ]}>
            Tenants
          </Text>
        ...
        <TouchableOpacity
          ...
          <Ionicons
            ...
            size={24}
            color={CurrentScreen == 'History' ? Colors.BLUE : Colors.GRAY}
          />
          <Text
            style={[
              styles.TabText,
