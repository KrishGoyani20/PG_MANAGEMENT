...
const PGManagment = () => {
    return (
        <View style={{ width: '100%', height: '100%', backgroundColor: '#999',justifyContent:'center'}}>
            ...
            <View style={{ width: '90%', height: 300, borderRadius: 10, backgroundColor: 'white', alignItems: 'center', alignSelf: 'center', padding: 10 }}>
                ...
                <Text style={{ fontSize: 16, fontWeight: 600, textAlign: 'center' }}>Rent: 200/day</Text>
                <View style={{
                    width: '95%',
