    ...
    return (
        <SafeAreaView style={{
            ...
            <View
                ...
                <View>
                    <FlatList
                        data={RoomNumber} // <-- flat list, NOT grouped
                        ...
                        renderItem={({ item: bed }) => {
                            ...
                            return (
                                <TouchableOpacity
                                    disabled={isDisabled}
                                    onPress={() => {
                                        if (bed.isBooked && isTrueRound) return;
                                    ...
                                    <Image
                                        ...
                                        source={
                                            isSelected || isCurrentlyFilled ? bed.badW : bed.image
                                        }
                                    />
                                    {/* <View
                        style={{
